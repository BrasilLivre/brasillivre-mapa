...
apiKey=sys.argv[1]
badCriminalData=[]
criminal = json.loads(open('../json/1995-2010-healed(cidadesInseridas).json').read())
...
with open('../json/1995-2010-healed(cidadesInseridas)(dadosGeoInseridos).json', 'w') as fp:
